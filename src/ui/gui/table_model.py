...
class TableModel(QAbstractTableModel):
    def __init__(self, transaction_list: list[Transaction] | None = None, parent: QObject | None = None):
        super().__init__(parent)
        self._transaction_list: list[Transaction] = transaction_list or []
        self._column_names: list[str] = ['Id', 'Data', 'Tipo', 'Categoria', 'Descrição', 'Valor']
